...
* **Improved information sharing and situational awareness** – Establishing a 4-hour notification time frame for all incidents to improve Texas A&M System Cybersecurity’s ability to understand cybersecurity events affecting the system and make timely required notifications to other system offices
...
The information elements described in steps 1-5 below are required when notifying Texas A&M System Cybersecurity of an incident:
...
Submit the notification to Texas A&M System Cybersecurity via the [ISAO Portal](https://portal.cyber.tamus.edu). [Detailed instructions are available here](/submitting-incident-notifications/).
...
* [ISAO Portal](https://portal.cyber.tamus.edu)
...
* Cybersecurity Operations Service Desk: (979) 234-0030 Opt. 3
