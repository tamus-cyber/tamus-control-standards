...
image::assets/banner.png[Cybersecurity Control Standards - The Texas A&M University System]

== Release History

Last Revised: {{ honkit.time }}

link:https://github.com/tamus-cyber/tamus-control-standards/releases[View this document's release history in GitHub.]
...
To simplify the review of security control standards that are required by Texas DIR or the Texas A&M System, an abbreviated list of xref:catalog/required-controls.adoc[Required Security Controls] and xref:catalog/new-controls.adoc[New Required Controls] is provided along with the required implementation date established by Texas DIR or the Texas A&M System. All changes and new controls are also annotated with change bars to the right of the text.
