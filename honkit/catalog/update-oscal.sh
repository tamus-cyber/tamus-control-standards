...
cp ~/OSCAL/content/tamus.edu/xml/TAMUS_2.0_resolved-profile_catalog.xml ./catalog.tmp
sed -i '' 's/<insert type="param" id-ref="\([a-z0-9._-]*\)"\/>/_[Assignment: {\1}]_/g' catalog.tmp
