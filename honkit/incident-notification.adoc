...
Notifications to affected third parties (e.g., vendors, partners) and affected individuals shall be made in accordance with Tex. Bus. & Comm. Code § 521.002{fn-txbcc-521_002} and guidance provided by the System Office of General Counsel.
...
Submit the notification to the System Office of Cybersecurity via the Information Security Incident Reporting Portal at https://cyber-infosharing.tamus.edu
